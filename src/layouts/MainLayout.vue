  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-img src="~assets/lago.jpg" class="absolute-top img-fondo"></q-img>
    ...
    <q-drawer
      ...
      <q-img class="absolute-top" src="~assets/lago.jpg" style="height: 142px">
        <div class="absolute-bottom bg-transparent">
          <q-avatar size="56px" class="q-mb-sm">
            <img src="https://cdn.quasar.dev/img/boy-avatar.png">
          </q-avatar>
          <div class="text-weight-bold">Matias Bensan</div>
          <div>@mbensan</div>
        </div>
      </q-img>
    </q-drawer>
